...
class Python3ParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by Python3Parser#funcdef_block.
    def enterFuncdef_block(self, ctx:Python3Parser.Funcdef_blockContext):
        pass

    # Exit a parse tree produced by Python3Parser#funcdef_block.
    def exitFuncdef_block(self, ctx:Python3Parser.Funcdef_blockContext):
        pass


    # Enter a parse tree produced by Python3Parser#func_name.
    def enterFunc_name(self, ctx:Python3Parser.Func_nameContext):
        pass

    # Exit a parse tree produced by Python3Parser#func_name.
    def exitFunc_name(self, ctx:Python3Parser.Func_nameContext):
        pass
