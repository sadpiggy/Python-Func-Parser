...
class JavaParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by JavaParser#method_name.
    def enterMethod_name(self, ctx:JavaParser.Method_nameContext):
        pass

    # Exit a parse tree produced by JavaParser#method_name.
    def exitMethod_name(self, ctx:JavaParser.Method_nameContext):
        pass
    ...
    # Enter a parse tree produced by JavaParser#paramater_name.
    def enterParamater_name(self, ctx:JavaParser.Paramater_nameContext):
        pass

    # Exit a parse tree produced by JavaParser#paramater_name.
    def exitParamater_name(self, ctx:JavaParser.Paramater_nameContext):
        pass
